...
var Bokeh = __webpack_require__(1);
...
var Field = function () {
  ...
  _createClass(Field, [{
    ...
    value: function _generatePoints() {
      var density = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 100;
    ...
    key: 'recolorPoints',
    value: function recolorPoints(color) {
      var _this2 = this;

      this.pointColor = color;
      this.points.forEach(function (point) {
        point.recolor(_this2.pointColor);
      });
    }
  }, {
    key: 'setGradient',
    value: function setGradient(colors) {
      ...
      this.points.forEach(function (point) {
        point.addGradient(_this3.gradient);
      });
    }
  }, {
    ...
    value: function resizePoints(newMaxRadius) {
      ...
      this.points.forEach(function (point) {
        point.resize(_this4.pointRadius);
      });
    }
  }, {
    key: 'changeDensity',
    ...
    value: function changeHalflife(newHalflife) {
      ...
      this.points.forEach(function (point) {
        point.changeHalflife(_this5.pointHalflife);
      });
    }
  }, {
    key: 'changeDX',
...
var Point = function () {
  function Point(_ref) {
    var canvas = _ref.canvas,
        ...
        color = _ref$color === undefined ? { r: 77, g: 101, b: 181 } : _ref$color,
        _ref$gradient = _ref.gradient,
        gradient = _ref$gradient === undefined ? null : _ref$gradient,
        _ref$halflifeRatio = _ref.halflifeRatio,
        halflifeRatio = _ref$halflifeRatio === undefined ? 250 : _ref$halflifeRatio,
        _ref$maxRadius = _ref.maxRadius,
        maxRadius = _ref$maxRadius === undefined ? 35 : _ref$maxRadius,
        _ref$maxDX = _ref.maxDX,
        maxDX = _ref$maxDX === undefined ? 5 : _ref$maxDX,
        _ref$maxDY = _ref.maxDY,
        maxDY = _ref$maxDY === undefined ? 2 : _ref$maxDY;
