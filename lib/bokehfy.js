...
var defaults = {
  transparent: false,
  backgroundColor: 'rgb(49, 159, 159)',
  density: 90,
  framerate: 30,
  gradient: [{ r: 255, g: 255, b: 255 }, { r: 255, g: 255, b: 255 }, { r: 255, g: 255, b: 255 }],
  halflife: 750,
  radius: 120,
  dx: 2,
  dy: 2,
...
var Bokeh = __webpack_require__(3);
...
var bokehfy = function bokehfy() {
  var settings = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : window.document.body;

  if (settings === Object(settings) && (typeof settings === 'undefined' ? 'undefined' : _typeof(settings)) === 'object') {
    if (isValidElement(settings)) {
      ...
      var _settingsObj = Object.assign({}, settings, { parent: window.document.body });
      return new Bokeh(_settingsObj);
    }
  } else {
    return null;
  }
...
var _require = __webpack_require__(7),
    isValidNumber = _require.isValidNumber,
    fixInRange = _require.fixInRange;

var Bokeh = function () {
  function Bokeh(settings) {
  ...
  _createClass(Bokeh, [{
    ...
    value: function settings(obj) {
      ...
      if (obj === Object(obj) && (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) === 'object') {
        var array = Object.entries(obj);
        array.forEach(function (cmd) {
          var key = cmd[0];
          var args = cmd[1];
          if (_this.API.hasOwnProperty(key)) {
            var func = _this.API[key];
    ...
    value: function backgroundColor() {
      var newColor = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    ...
    key: 'radius',
    value: function radius(newMaxRadius) {
      if (this.field && isValidNumber(newMaxRadius)) {
        var fixedMaxRadius = fixInRange(newMaxRadius, 0.00001, 1000);
    ...
    value: function color() {
      var newPointColor = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

      var color = tinyColor(newPointColor);
      if (color.isValid() && this.field) {
    ...
    key: 'star',
    value: function star() {
      var newStarColor = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

      var color = tinyColor(newStarColor);
      if (color.isValid() && this.field) {
    ...
    key: 'gradient',
    value: function gradient(colorArray) {
      if (Array.isArray(colorArray) && colorArray.length) {
        var colors = colorArray.map(function (color) {
    ...
    key: 'density',
    value: function density(newDensity) {
      if (this.field && isValidNumber(newDensity)) {
        var fixedDensity = fixInRange(newDensity, 0, 2000);
        this.field.changeDensity(fixedDensity);
      }
    }
  }, {
    key: 'halflife',
    value: function halflife(newHalflife) {
      if (this.field && isValidNumber(newHalflife)) {
        var fixedHalflife = fixInRange(newHalflife, 0.00001, 10000);
        this.field.changeHalflife(fixedHalflife);
      }
    }
  }, {
    key: 'framerate',
    value: function framerate(newFramerate) {
      if (this.field && isValidNumber(newFramerate)) {
        var fixedFramerate = fixInRange(newFramerate, 0, 10000);
        this.field.changeFramerate(fixedFramerate);
      }
    }
  }, {
    key: 'dx',
    value: function dx(newDX) {
      if (this.field && isValidNumber(newDX)) {
        var fixedDX = fixInRange(newDX, 0, 10000);
        this.field.changeDX(fixedDX);
      }
    }
  }, {
    key: 'dy',
    value: function dy(newDY) {
      if (this.field && isValidNumber(newDY)) {
        var fixedDY = fixInRange(newDY, 0, 10000);
        this.field.changeDY(fixedDY);
      }
    }
  }, {
    key: 'stepDx',
    value: function stepDx(increment) {
    ...
    key: 'stepDy',
    value: function stepDy(increment) {
      if (this.field && isValidNumber(increment)) {
    ...
    key: 'stepRadius',
    value: function stepRadius(increment) {
      if (this.field && isValidNumber(increment)) {
...
var Field = function () {
  ...
  _createClass(Field, [{
    ...
    value: function _setInterval() {
      var framerate = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULTS.framerate;
    ...
    value: function _generatePoints() {
      var density = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULTS.density;
    ...
    value: function start() {
      ...
      var draw = function draw(timestamp) {
        ...
        if (delta > _this.interval) {
          _this._clear();
          _this._animatePoints();

          then = now - delta % _this.interval;
        }
    ...
    key: 'getSettings',
    value: function getSettings() {
      var newBG = tinyColor(this.BG).toRgb();
      var newGradient = this.gradient.map(function (color) {
    ...
    value: function setGradient(colors) {
      ...
      this.points.forEach(function (point) {
        point.addGradient(_this2.gradient);
      });
    }
  }, {
    ...
    key: 'setTransparency',
    value: function setTransparency(isTrans) {
      this.transparent = isTrans;
    }
  }, {
    key: 'resizePoints',
    value: function resizePoints(newMaxRadius) {
      var _this3 = this;

      this.pointRadius = newMaxRadius;
      this.points.forEach(function (point) {
        point.resize(_this3.pointRadius);
      });
    }
  }, {
    key: 'changeDensity',
    value: function changeDensity(newDensity) {
      this.points = this._generatePoints(newDensity);
    }
  }, {
    key: 'changeHalflife',
    value: function changeHalflife(newHalflife) {
      var _this4 = this;

      this.pointHalflife = newHalflife;
      this.points.forEach(function (point) {
        point.changeHalflife(_this4.pointHalflife);
      });
    }
  }, {
    key: 'changeDX',
    value: function changeDX(newDX) {
      var _this5 = this;

      this.pointDX = newDX;
      this.points.forEach(function (point) {
        point.changeDX(_this5.pointDX);
      });
    }
  }, {
    key: 'changeDY',
    value: function changeDY(newDY) {
      var _this6 = this;

      this.pointDY = newDY;
      this.points.forEach(function (point) {
        point.changeDY(_this6.pointDY);
      });
    }
  }, {
    key: 'stepDX',
    ...
    key: 'changeFramerate',
    value: function changeFramerate(newFramerate) {
      this.interval = this._setInterval(newFramerate);
    }
  }, {
    key: 'setInteractiveState',
    value: function setInteractiveState(isInteractive) {
...
var DEFAULT = __webpack_require__(0);
...
var Point = function () {
  function Point(_ref) {
    var canvas = _ref.canvas,
        ...
        gradient = _ref$gradient === undefined ? DEFAULT.gradient : _ref$gradient,
        _ref$halflifeRatio = _ref.halflifeRatio,
        halflifeRatio = _ref$halflifeRatio === undefined ? DEFAULT.halflife : _ref$halflifeRatio,
        _ref$maxRadius = _ref.maxRadius,
        maxRadius = _ref$maxRadius === undefined ? DEFAULT.radius : _ref$maxRadius,
        _ref$maxDX = _ref.maxDX,
        maxDX = _ref$maxDX === undefined ? DEFAULT.dx : _ref$maxDX,
        _ref$maxDY = _ref.maxDY,
        maxDY = _ref$maxDY === undefined ? DEFAULT.dy : _ref$maxDY;
  ...
  _createClass(Point, [{
    key: '_checkFocus',
    value: function _checkFocus(mouse) {
      var xdist = Math.abs(this.x - mouse.x);
      var ydist = Math.abs(this.y - mouse.y);
      return xdist * .9 <= this.r && ydist * .9 <= this.r;
    }
  }, {
    key: 'interact',
    value: function interact(mouse) {
      var isFocused = this._checkFocus(mouse);
      if (isFocused) {
        this.ratio = .001;
      }
    }
    ...
    value: function createGradient() {
      var grads = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

      var opacity = 1 - this.ratio / this.halflife;
    ...
    key: 'addGradient',
    value: function addGradient(newGradientArray) {
    ...
    key: 'resize',
    value: function resize(newMaxRadius) {
    ...
    key: 'stepRadius',
    value: function stepRadius(increment) {
      var newRadius = this.r + increment;
      var newMaxRadius = this.max_r + increment;
...
var Mouse = function () {
    ...
    _createClass(Mouse, [{
        ...
        value: function mouseMoveListener(canvas) {
            var _this = this;

            var func = function func(e) {
                var pos = _this.getPos(canvas, e);
                _this.x = pos.x;
                _this.y = pos.y;
            };

            var throttledFunc = throttle(func);

            return throttledFunc;
        }
    }, {
        key: 'getPos',
        value: function getPos(canvas, evt) {
